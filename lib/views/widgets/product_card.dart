          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                child: shoppingController.products[index].image == "" ||
            ...
            Positioned(
                right: 5,
                top: 5,
                child: shoppingController.products[index].isLiked
                    ? IconButton(
                        onPressed: () {
                          shoppingController.productDisliked(
                              shoppingController.products[index].id ?? 0);
                          userController.removeLikedProducts(shoppingController.products[index].id ?? 0);
                        },
                    ...
                    : IconButton(
                        onPressed: () {
                          shoppingController.productLiked(
                              shoppingController.products[index].id ?? 0);
                          userController.addLikedProducts(shoppingController.products[index]);
                        },
                        icon: SvgPicture.asset(
              ...
              child: Container(
                ...
                child: Column(
                    ...
                    children: [
                      Text(
                        Maps.category[
                                shoppingController.products[index].category] ??
                            "-",
